...
namespace max7219_matrix {
    ...
    */
    //% block="Display Number $customCharArray offset $offset|clear screen first $clear" offset.min=-8 clear.defl=true group="2. Display Number on matrixs" blockExternalInputs=true
